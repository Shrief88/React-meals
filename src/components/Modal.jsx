...
function Modal(){
    ...
    return(
        <div className='w-full h-full fixed left-0 right-0 top-0 bottom-0 bg-overrelay flex justify-center items-center'>
            <div className='bg-white flex flex-col px-5 py-8 rounded-3xl gap-3'>
                <div className='flex'>
